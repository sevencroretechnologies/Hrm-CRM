...
class Contract extends Model
{
    ...
    protected $fillable = [
        'org_id', 'staff_id', 'party_type', 'party_name', 'party_user_id',
        'status', 'fulfilment_status', 'is_signed', 'start_date', 'end_date',
        'signee', 'signed_on', 'ip_address', 'contract_template', 'contract_terms',
        'requires_fulfilment', 'fulfilment_deadline', 'signee_company',
        'signed_by_company', 'document_type', 'document_name', 'party_full_name',
    ];
