...
class Lead extends Model
{
    ...
    protected $fillable = [
        'org_id', 'staff_id', 'salutation', 'first_name', 'middle_name', 'last_name',
        'lead_name', 'job_title', 'gender', 'lead_owner_id', 'status', 'type',
        'request_type', 'email_id', 'website', 'mobile_no', 'whatsapp_no', 'phone',
        'phone_ext', 'company_name', 'no_of_employees', 'annual_revenue', 'industry',
